 ...
 * For an explanation of each annotation not already annotated here, see Breed.java
 */
...
public class Appointment {
    ...
    // Generate means this value is generated by the database, so once it is generated the value is set to the generated value.
    @Generated
    @Column(name = "created_at")
    private Instant createdAt;

    // Mandatory foreign key from appointments to breeds.
    // One breed can have many appointments.
    ...
    public void complete(int actualDurationMinutes) {
        /**
         * Sets the completedAt and actualDurationMinutes values of an appointment
         */
